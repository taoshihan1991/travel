    ...
    <div class="cms-publish-content" id="main-nav-holder">
      <div class="cms-publish-sidebar" id="main-nav">
        <div class="upload-btn"><a href="javascript:void(0);"><span>
          <input type="file" name="article_image_upload" id="article_image_upload" multiple=""  file_id="0" style="width:120px; height: 40px; cursor: pointer; opacity:0; filter: alpha(opacity=0)" size="1" hidefocus="true" maxlength="0" />
          </span>
