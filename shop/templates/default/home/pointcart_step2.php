    ...
    <div class="ncc-title">
      ...
      <div class="ncc-receipt-info mb30">
        <div class="ncc-finish-a"><i></i><?php echo $lang['pointcart_step2_order_created'];?>
          <span class="all-points"><?php echo $lang['pointcart_step2_order_allpoints'].$lang['nc_colon'];?><em><?php echo $output['order_arr']['pgoods_pointall']; ?></em></span> </div>
        ...
        <div class="ncc-finish-c mb30"><a class="ncc-btn-mini ncc-btn-green mr15" href="<?php echo SHOP_SITE_URL?>"><i class="icon-shopping-cart"></i>继续购物</a><a class="ncc-btn-mini ncc-btn-acidblue" href="index.php?act=member_pointorder&op=order_info&order_id=<?php echo $output['order_arr']['order_id'];?>"><i class="icon-file-text-alt"></i><?php echo $lang['pointcart_step2_view_order'];?></a></div>
      </div>
  </div>
</div>
